...
//end column ID, Result
  ...
  P4Result = P4Result.split(" : ");
  var P4H = Number(P4Result[0]);
  var P4A = Number(P4Result[1]);
  ...
  addClass(P4ResultEl, ResultH, ResultA, P4H, P4A);
